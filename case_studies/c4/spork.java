...
public class PrimitiveParameterTypesAcceptanceTests {
    public interface MethodsWithPrimitiveTypes {
        public abstract void withBoolean(boolean b);

        public abstract void withByte(byte b);

        public abstract void withShort(short s);

        public abstract void withInt(int i);

        public abstract void withLong(long l);

        public abstract void withFloat(float f);

        public abstract void withDouble(double d);
    }

    public final Mockery context = new Mockery();

    private final MethodsWithPrimitiveTypes mock = context.mock(PrimitiveParameterTypesAcceptanceTests.MethodsWithPrimitiveTypes.class, "mock");
