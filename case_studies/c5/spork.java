    ...
    int[] setFlags) {
        ...
        try {
            ...
            if ((token != JSONToken.LBRACE) && (token != JSONToken.COMMA)) {
                ...
                if (token == JSONToken.LITERAL_STRING) {
                    ...
                    if (beanInfo.jsonType != null) {
                        for (Class<?> seeAlsoClass : beanInfo.jsonType.seeAlso()) {
                            if (java.lang.Enum.class.isAssignableFrom(seeAlsoClass)) {
                                try {
                ...
                // 
                // 
                new StringBuffer().append("syntax error, expect {, actual ").append(lexer.tokenName()).append(", pos ").append(lexer.pos());
            ...
            for (int fieldIndex = 0; ; fieldIndex++) {
                ...
                if (fieldDeser != null) {
                    ...
                    if ((fieldClass == int.class) || (fieldClass == java.lang.Integer.class)) {
                    ...
                    } else if ((fieldClass == long.class) || (fieldClass == java.lang.Long.class)) {
                    ...
                    } else if ((fieldClass == boolean.class) || (fieldClass == java.lang.Boolean.class)) {
                    ...
                    } else if ((fieldClass == float.class) || (fieldClass == java.lang.Float.class)) {
                    ...
                    } else if ((fieldClass == double.class) || (fieldClass == java.lang.Double.class)) {
                     ...
                     && (parser.getConfig().getDeserializer(fieldClass) instanceof EnumDeserializer)) && ((feildAnnotation == null) || (feildAnnotation.deserializeUsing() == java.lang.Void.class))) {
                    ...
                    for (int i = 0; i < paramNames.length; i++) {
                        ...
                        if (param == null) {
                            ...
                            if (fieldType == byte.class) {
                                ...
                                param = Boolean.FALSE;
                            } else if ((fieldType == java.lang.String.class) && ((fieldInfo.parserFeatures & Feature.InitStringFieldAsEmpty.mask) != 0)) {
                                param = "";
                            }
                        }
                        params[i] = param;
